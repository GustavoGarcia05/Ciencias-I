...
public class Parseador {
     ...
     *
     * @param expresionParseada Esta es una expresi�n en notaci�n postfija (se
     * puede obtener con la funci�n parsear).
...
//			throw new ArithmeticException("Valor no real en la expresi�n");
    ...
    /**
     * sacaOperadores saca los operadores que tienen mayor prioridad y mete el
     * nuevo operador
     */
